...
int main()
{
	...
	//MAP
	Texture mapTexture;
	mapTexture.loadFromFile("Images/map.jpg");
	...
	while (window.isOpen())
	{
		std::cout << player.GetPlayerPosition().x<<"  " << player.GetPlayerPosition().y << "\n";
		...
		if (Keyboard::isKeyPressed(Keyboard::Space) and bulletShot > 800){ //--------------CREATING BULLETS
